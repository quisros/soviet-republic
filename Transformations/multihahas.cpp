...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "wicked plans", NULL, NULL);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        trans = glm::rotate(trans, (float)pow(timeValue,1.5), glm::vec3(0.0f, 0.0f, 1.0f));
        
        shaderProgram.use();
        shaderProgram.setFloat("coeff", sin(timeValue)/2.0f + 0.5f);
        ...
        trans1 = glm::scale(trans1, glm::vec3(sin(timeValue), sin(timeValue), 1.0f));
