...
glm::vec3 sunPosn = glm::vec3 (-200.0f, 0.0f, 0.0f);
...
int main () {
    ...
    Texture diffmap("textures/earth/8kdaymap.jpg");
    ...
    containerShader.setVec3("dirLight.ambient",  0.3f, 0.3f, 0.3f);
