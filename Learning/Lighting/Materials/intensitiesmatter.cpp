...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "lighting up my life", NULL, NULL);
    ...
    Shader containerShader("shaders/diffusestart.vs", "shaders/materialcompints.fs");
