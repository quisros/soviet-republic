...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "why does it hurt", NULL, NULL);
    ...
    Shader containerShader("shaders/diffusemapinit.vs", "shaders/flashlight.fs");
    ...
    containerShader.setVec3("light.diffuse",  0.7f, 0.7f, 0.7f);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        modelSrc = glm::translate(modelSrc, lightPos);
