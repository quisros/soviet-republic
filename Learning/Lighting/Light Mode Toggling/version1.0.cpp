...
int main () {
    ...
    Shader containerShader("shaders/blinnnormtanspace.vs", "shaders/blinnnormtanspace.fs");
    ...
    containerShader.setVec3("dirLight.ambient",  0.1f, 0.1f, 0.1f);
    ...
    for(int i = 0; i<srcarraylen; i++) {
        ...
        containerShader.setVec3(pointName+"ambient",  0.1f, 0.1f, 0.1f);
        containerShader.setVec3(pointName+"diffuse",  0.6f, 0.6f, 0.6f);
        containerShader.setVec3(pointName+"specular", 1.0f, 1.0f, 1.0f);
        
    }
    
    
    containerShader.setVec3("spotLight.ambient",  0.1f, 0.1f, 0.1f);
...
void processInput(GLFWwindow *window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS && !blinnKeyPressed) {
        blinncarrier = !blinncarrier;
        blinnKeyPressed = true;
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_O) == GLFW_PRESS && !blinnKeyPressed) {
        blinncarrier = !blinncarrier;
        blinnKeyPressed = true;
    }
