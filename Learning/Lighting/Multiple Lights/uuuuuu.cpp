...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "we can do this", NULL, NULL);
    ...
    Shader containerShader("shaders/diffusemapinit.vs", "shaders/multlightsinit.fs");
    ...
    Texture diffmap("textures/steelbox.png");
    Texture specmap("textures/blackwhitebox.png");
    ...
    for(int i = 0; i<arraylen; i++) {
        ...
        containerShader.setVec3(pointName+"diffuse",  0.4f, 0.4f, 0.4f);
