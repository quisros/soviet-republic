...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "night changes", NULL, NULL);
    ...
    Shader cubeShader("shaders/reflectinit.vs", "shaders/reflectinit.fs");
    ...
    */
    ...
    Texture tex1("textures/perrykick.jpg");
    Texture tex2("textures/lines.jpg");
