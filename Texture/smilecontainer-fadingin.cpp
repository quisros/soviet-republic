...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "void main ()\n"
    "{\n"
    "    FragColor = mix(texture(texture1, TexCoord), texture(texture2, TexCoord), coeff);\n"
    "}\0";
...
int main () {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Fade In", NULL, NULL);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        int coeffColorLocation = glGetUniformLocation(shaderProgram, "coeff");
